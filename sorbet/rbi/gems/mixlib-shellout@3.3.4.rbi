...
module Mixlib::ShellOut::Unix
  ...
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#58
  def logon_environment; end

  # Merges the two environments for the process
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#69
  ...
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#91
  def run_command; end
  ...
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#49
  def sgids; end
  ...
  # @return [Boolean]
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#31
  def using_login?; end
  ...
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#190
  def child_stdin; end
  ...
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#239
  ...
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#307
  def fork_subprocess; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#185
  def initialize_ipc; end

  # Some patch levels of ruby in wide use (in particular the ruby 1.8.6 on OSX)
  # segfault when you IO.select a pipe that's reached eof. Weak sauce.
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#256
  def open_pipes; end
  ...
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#347
  def propagate_pre_exec_failure; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#298
  def read_process_status_to_buffer; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#288
  def read_stderr_to_buffer; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#278
  ...
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#384
  def reap; end
  ...
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#164
  def set_environment; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#151
  def set_group; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#158
  def set_secondarygroups; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#171
  def set_umask; end

  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#144
  def set_user; end

  # @return [Boolean]
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#376
  def should_reap?; end

  # Keep this unbuffered for now
  #
  # source://mixlib-shellout//lib/mixlib/shellout/unix.rb#261
