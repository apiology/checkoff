...
class RBS::CLI::Validate
  ...
  # source://rbs//lib/rbs/cli/validate.rb#341
  def no_classish_type_validator(type); end

  # source://rbs//lib/rbs/cli/validate.rb#335
  def no_self_type_validator(type); end

  # source://rbs//lib/rbs/cli/validate.rb#212
  ...
  # source://rbs//lib/rbs/cli/validate.rb#267
  def validate_constant; end

  # source://rbs//lib/rbs/cli/validate.rb#280
  def validate_global; end

  # source://rbs//lib/rbs/cli/validate.rb#221
  def validate_interface; end

  # source://rbs//lib/rbs/cli/validate.rb#292
  def validate_type_alias; end

  # source://rbs//lib/rbs/cli/validate.rb#347
