...
module OAuth2
  class << self
    # source://oauth2//lib/oauth2.rb#79
    def config; end
    ...
    #
    # source://oauth2//lib/oauth2.rb#89
    def configure; end
  end
end

# source://oauth2//lib/oauth2/auth_sanitizer.rb#0
module OAuth2::AUTH_SANITIZER
  class << self
    # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/core.rb#67
    def default_filtered_keys; end

    # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/core.rb#38
    def filtered_label; end

    # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/core.rb#54
...
module OAuth2::AUTH_SANITIZER::FilteredAttributes
  ...
  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#94
  def inspect; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#87
  def thing_filter; end

  private

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#115
  def redact_inspected_values(inspected); end

  class << self
    # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#24
...
module OAuth2::AUTH_SANITIZER::FilteredAttributes::ClassMethods
  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#77
  def filtered_attribute_names; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#70
  def filtered_attributes(*attributes); end

  class << self
    # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#59
    def filtered_attribute_names(base); end

    # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#51
...
module OAuth2::AUTH_SANITIZER::FilteredAttributes::InitializerMethods
  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/filtered_attributes.rb#35
  def initialize(*args, &block); end
end

# source://oauth2//lib/oauth2/auth_sanitizer.rb#0
class OAuth2::AUTH_SANITIZER::SanitizedLogger
  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#25
  def initialize(logger, filtered_keys: T.unsafe(nil), label: T.unsafe(nil)); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#49
  def <<(message); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#37
  def add(severity, message = T.unsafe(nil), progname = T.unsafe(nil)); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#110
  def close; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#58
  def debug(progname = T.unsafe(nil), &block); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#85
  def error(progname = T.unsafe(nil), &block); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#94
  def fatal(progname = T.unsafe(nil), &block); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#117
  def formatter; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#125
  def formatter=(formatter); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#67
  def info(progname = T.unsafe(nil), &block); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#132
  def level; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#140
  def level=(level); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#174
  def method_missing(method_name, *args, &block); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#147
  def progname; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#155
  def progname=(progname); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#103
  def unknown(progname = T.unsafe(nil), &block); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#76
  def warn(progname = T.unsafe(nil), &block); end

  private

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#188
  def log(level, progname = T.unsafe(nil)); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#164
  def respond_to_missing?(method_name, include_private = T.unsafe(nil)); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#200
  def sanitize(message); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#220
  def sanitize_authorization_header(message); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#238
  def sanitize_form_and_query_pairs(message); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#228
  def sanitize_json_pairs(message); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/sanitized_logger.rb#214
  def thing_filter; end
end

# source://oauth2//lib/oauth2/auth_sanitizer.rb#0
class OAuth2::AUTH_SANITIZER::ThingFilter
  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/thing_filter.rb#20
  def initialize(things, label:); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/thing_filter.rb#43
  def filtered?(thing_name); end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/thing_filter.rb#34
  def label; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/thing_filter.rb#54
  def pattern_source; end

  # source://auth-sanitizer/0.2.2/lib/auth/sanitizer/thing_filter.rb#29
  def things; end
end
...
class OAuth2::AccessToken
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#188
  def [](key); end
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#370
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#202
  def expired?; end
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#342
  def get(path, opts = T.unsafe(nil), &block); end

  # Get the headers hash (includes Authorization token)
  #
  # source://oauth2//lib/oauth2/access_token.rb#375
  def headers; end
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#363
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#349
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#356
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#217
  ...
  # @yieldparam req [Faraday::Request] The request object that can be modified
  #
  # source://oauth2//lib/oauth2/access_token.rb#266
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#300
  def to_hash; end
  ...
  # source://oauth2//lib/oauth2/access_token.rb#381
  def configure_authentication!(opts, verb); end

  # source://oauth2//lib/oauth2/access_token.rb#417
  ...
  class << self
    ...
    #
    # source://oauth2//lib/oauth2/access_token.rb#81
    ...
    #
    # source://oauth2//lib/oauth2/access_token.rb#88
...
class OAuth2::Authenticator
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#95
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#84
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#72
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#105
  ...
  class << self
    ...
    #
    # source://oauth2//lib/oauth2/authenticator.rb#60
...
#
# source://oauth2//lib/oauth2.rb#76
...
class OAuth2::Client
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#316
  def assertion; end
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#282
  def auth_code; end
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#303
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#272
  def http_method; end
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#289
  def implicit; end
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#296
  def password; end
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#341
  ...
  # @yieldparam req [Faraday::Request] The request object that can be modified
  #
  # source://oauth2//lib/oauth2/client.rb#147
  ...
  # @yieldparam req [Faraday::Request] The request object that can be modified
  #
  # source://oauth2//lib/oauth2/client.rb#259
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#120
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#112
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#517
  def authenticator; end

  # @return [Boolean]
  #
  # source://oauth2//lib/oauth2/client.rb#504
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#583
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#602
  ...
  # @yieldparam req [Faraday::Request] the request object that can be modified
  #
  # source://oauth2//lib/oauth2/client.rb#447
  def execute_request(verb, url, opts = T.unsafe(nil)); end

  # source://oauth2//lib/oauth2/client.rb#611
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#364
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#558
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#535
  ...
  #   - HTTP headers (Hash)
  #
  # source://oauth2//lib/oauth2/client.rb#409
  def parse_snaky_params_headers(params); end

  # source://oauth2//lib/oauth2/client.rb#477
  ...
  # source://oauth2//lib/oauth2/client.rb#491
...
#
# source://oauth2//lib/oauth2.rb#58
...
class OAuth2::Error < ::StandardError
  ...
  #
  # source://oauth2//lib/oauth2/error.rb#48
  ...
  #
  # source://oauth2//lib/oauth2/error.rb#71
...
#
# source://oauth2//lib/oauth2/filtered_attributes.rb#9
...
# @since 1.0.0
#
# source://oauth2//lib/oauth2/response.rb#13
class OAuth2::Response
  ...
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#75
  ...
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#101
  def body; end
  ...
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#136
  ...
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#87
  def headers; end

  # @return [Hash] The options hash for this instance
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#27
  def options; end
  ...
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#109
  def parsed; end
  ...
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#157
  def parser; end

  # @return [Faraday::Response] The raw Faraday response object
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#24
  def response; end
  ...
  # @since 1.0.0
  #
  # source://oauth2//lib/oauth2/response.rb#94
  def status; end
  ...
  class << self
    ...
    #
    # source://oauth2//lib/oauth2/response.rb#55
...
# @since 1.0.0
#
# source://oauth2//lib/oauth2/response.rb#17
...
#
# source://oauth2//lib/oauth2/version.rb#7
