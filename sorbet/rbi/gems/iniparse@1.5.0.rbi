...
# pkg:gem/iniparse#lib/iniparse/document.rb:1
module IniParse
  private
  ...
  # IniParse::Document
  #
  # pkg:gem/iniparse#lib/iniparse.rb:63
  def gen(&blk); end
  ...
  # IniParse::Document
  #
  # pkg:gem/iniparse#lib/iniparse.rb:50
  def open(path); end
  ...
  # IniParse::Document
  #
  # pkg:gem/iniparse#lib/iniparse.rb:38
...
#
# pkg:gem/iniparse#lib/iniparse/document.rb:3
class IniParse::Document
  include ::Enumerable

  # Creates a new Document instance.
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:10
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:31
  def [](key); end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:47
  def delete(*args); end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:23
  def each(*args, &blk); end

  # Returns true if a section with the given +key+ exists in this document.
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:87
  def has_section?(key); end

  # A human-readable version of the document, for debugging.
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:81
  def inspect; end

  # pkg:gem/iniparse#lib/iniparse/document.rb:6
  def lines; end

  # pkg:gem/iniparse#lib/iniparse/document.rb:7
  def path; end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:104
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:39
  def section(key); end

  # pkg:gem/iniparse#lib/iniparse/document.rb:78
  def to_h; end

  # Returns a has representation of the INI with multi-line options
  # as an array
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:64
  def to_hash; end

  # Returns this document as a string suitable for saving to a file.
  #
  # pkg:gem/iniparse#lib/iniparse/document.rb:53
  def to_ini; end

  # pkg:gem/iniparse#lib/iniparse/document.rb:60
  def to_s; end
end
...
#
# pkg:gem/iniparse#lib/iniparse/generator.rb:73
class IniParse::Generator
  # pkg:gem/iniparse#lib/iniparse/generator.rb:77
  def initialize(opts = T.unsafe(nil)); end

  # Adds a new blank line to the document.
  #
  # pkg:gem/iniparse#lib/iniparse/generator.rb:170
  def blank; end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/generator.rb:163
  def comment(comment, opts = T.unsafe(nil)); end

  # pkg:gem/iniparse#lib/iniparse/generator.rb:74
  def context; end

  # pkg:gem/iniparse#lib/iniparse/generator.rb:75
  def document; end

  # pkg:gem/iniparse#lib/iniparse/generator.rb:85
  def gen; end

  # pkg:gem/iniparse#lib/iniparse/generator.rb:183
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/generator.rb:147
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/generator.rb:107
  def section(name, opts = T.unsafe(nil)); end

  # Wraps lines, setting default options for each.
  #
  # pkg:gem/iniparse#lib/iniparse/generator.rb:175
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/generator.rb:200
  ...
  class << self
    ...
    # IniParse::Document
    #
    # pkg:gem/iniparse#lib/iniparse/generator.rb:95
...
#
# pkg:gem/iniparse#lib/iniparse.rb:13
...
#
# pkg:gem/iniparse#lib/iniparse/line_collection.rb:12
module IniParse::LineCollection
  include ::Enumerable

  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:15
  def initialize; end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:46
  def <<(line); end

  # Retrive a value identified by +key+.
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:21
  def [](key); end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:30
  def []=(key, value); end

  # Removes the value identified by +key+.
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:70
  def delete(key); end
  ...
  # include_blank<Boolean>:: Include blank/comment lines?
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:59
  def each(include_blank = T.unsafe(nil)); end

  # Returns whether +key+ is in the collection.
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:81
  def has_key?(*args); end

  # Return an array containing the keys for the lines added to this
  # collection.
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:87
  def keys; end

  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:50
  def push(line); end

  # Returns this collection as an array. Includes blank and comment lines.
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:92
  def to_a; end

  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:102
  def to_h; end

  # Returns this collection as a hash. Does not contain blank and comment
  # lines.
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:98
  def to_hash; end
end
...
#
# pkg:gem/iniparse#lib/iniparse.rb:24
class IniParse::LineNotAllowed < ::IniParse::IniParseError; end

# pkg:gem/iniparse#lib/iniparse/lines.rb:2
module IniParse::Lines; end

# Stores options which appear at the beginning of a file, without a
# preceding section.
#
# pkg:gem/iniparse#lib/iniparse/lines.rb:225
class IniParse::Lines::AnonymousSection < ::IniParse::Lines::Section
  # pkg:gem/iniparse#lib/iniparse/lines.rb:226
  def initialize; end

  # pkg:gem/iniparse#lib/iniparse/lines.rb:230
  def to_ini; end

  private

  # pkg:gem/iniparse#lib/iniparse/lines.rb:240
...
#
# pkg:gem/iniparse#lib/iniparse/lines.rb:307
class IniParse::Lines::Blank
  include ::IniParse::Lines::Line

  # pkg:gem/iniparse#lib/iniparse/lines.rb:310
  def blank?; end

  class << self
    # pkg:gem/iniparse#lib/iniparse/lines.rb:314
...
#   # also a comment
#
# pkg:gem/iniparse#lib/iniparse/lines.rb:330
class IniParse::Lines::Comment < ::IniParse::Lines::Blank
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:348
  def comment; end
  ...
  # real-world example.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:338
  def has_comment?; end
end

# A base class from which other line types should inherit.
#
# pkg:gem/iniparse#lib/iniparse/lines.rb:4
module IniParse::Lines::Line
  # ==== Parameters
  # opts<Hash>:: Extra options for the line.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:8
  def initialize(opts = T.unsafe(nil)); end

  # Returns whether this is a line which has no data.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:47
  def blank?; end

  # Returns the inline comment for this line. Includes the comment
  # separator at the beginning of the string.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:42
  def comment; end

  # Returns if this line has an inline comment.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:18
  def has_comment?; end

  # Returns the contents for this line.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:36
  def line_contents; end

  # Returns the options used to create the line
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:52
  def options; end

  # Returns this line as a string as it would be represented in an INI
  # document.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:24
  def to_ini; end
end
...
#   key = value
#
# pkg:gem/iniparse#lib/iniparse/lines.rb:250
class IniParse::Lines::Option
  ...
  # opts<Hash>::    Extra options for the line.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:265
  def initialize(key, value, opts = T.unsafe(nil)); end

  # pkg:gem/iniparse#lib/iniparse/lines.rb:258
  def key; end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:296
  def line_contents; end

  class << self
    # pkg:gem/iniparse#lib/iniparse/lines.rb:271
    def parse(line, opts); end

    # Attempts to typecast values.
    #
    # pkg:gem/iniparse#lib/iniparse/lines.rb:279
...
#   ...
#
# pkg:gem/iniparse#lib/iniparse/lines.rb:72
class IniParse::Lines::Section
  ...
  # opts<Hash>::  Extra options for the line.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:89
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:162
  def [](key); end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:145
  def []=(key, value); end
  ...
  # Returns the section.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:178
  def delete(*args); end
  ...
  # include_blank<Boolean>:: Include blank/comment lines?
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:127
  def each(*args, &blk); end

  # Returns true if an option with the given +key+ exists in this section.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:193
  def has_option?(key); end

  # pkg:gem/iniparse#lib/iniparse/lines.rb:80
  def key; end

  # pkg:gem/iniparse#lib/iniparse/lines.rb:80
  def key=(_arg0); end

  # pkg:gem/iniparse#lib/iniparse/lines.rb:81
  def lines; end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:204
  def merge!(other); end
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:188
  def option(key); end

  # Returns this line as a string as it would be represented in an INI
  # document. Includes options, comments and blanks.
  #
  # pkg:gem/iniparse#lib/iniparse/lines.rb:103
  def to_ini; end

  private

  # pkg:gem/iniparse#lib/iniparse/lines.rb:218
  def line_contents; end

  class << self
    # pkg:gem/iniparse#lib/iniparse/lines.rb:95
    def parse(line, opts); end
  end
end
...
# section.
#
# pkg:gem/iniparse#lib/iniparse.rb:20
...
#
# pkg:gem/iniparse#lib/iniparse/line_collection.rb:140
class IniParse::OptionCollection
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:151
  def <<(line); end

  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:166
  def each(*args); end

  # Return an array containing the keys for the lines added to this
  # collection.
  #
  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:180
  def keys; end
end

# Raised if an error occurs parsing an INI document.
#
# pkg:gem/iniparse#lib/iniparse.rb:16
class IniParse::ParseError < ::IniParse::IniParseError; end

# pkg:gem/iniparse#lib/iniparse/parser.rb:2
class IniParse::Parser
  ...
  #
  # pkg:gem/iniparse#lib/iniparse/parser.rb:31
  ...
  # IniParse::Document
  #
  # pkg:gem/iniparse#lib/iniparse/parser.rb:40
  def parse; end
  ...
  class << self
    ...
    #
    # pkg:gem/iniparse#lib/iniparse/parser.rb:56
    ...
    # Array
    #
    # pkg:gem/iniparse#lib/iniparse/parser.rb:9
    def parse_types; end
    ...
    #
    # pkg:gem/iniparse#lib/iniparse/parser.rb:19
...
#
# pkg:gem/iniparse#lib/iniparse/line_collection.rb:112
class IniParse::SectionCollection
  include ::Enumerable
  include ::IniParse::LineCollection

  # pkg:gem/iniparse#lib/iniparse/line_collection.rb:115
  def <<(line); end
end

# pkg:gem/iniparse#lib/iniparse.rb:10
