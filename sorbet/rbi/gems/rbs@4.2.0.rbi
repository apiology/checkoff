...
class RBS::CLI
  # pkg:gem/rbs#lib/rbs/cli.rb:91
  def initialize(stdout:, stderr:); end

  # pkg:gem/rbs#lib/rbs/cli.rb:1144
  def collection_options(args); end

  # pkg:gem/rbs#lib/rbs/cli.rb:111
  def has_parser?; end

  # pkg:gem/rbs#lib/rbs/cli.rb:89
  def original_args; end

  # pkg:gem/rbs#lib/rbs/cli.rb:98
  def parse_logging_options(opts); end

  # pkg:gem/rbs#lib/rbs/cli.rb:115
  def run(args); end

  # pkg:gem/rbs#lib/rbs/cli.rb:265
  def run_ancestors(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:959
  def run_annotate(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:148
  def run_ast(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:1081
  def run_collection(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:461
  def run_constant(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:1249
  def run_diff(argv, library_options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:200
  def run_list(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:388
  def run_method(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:330
  def run_methods(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:907
  def run_parse(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:521
  def run_paths(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:565
  def run_prototype(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:685
  def run_prototype_file(format, args); end

  # pkg:gem/rbs#lib/rbs/cli.rb:1168
  def run_subtract(args, _); end

  # pkg:gem/rbs#lib/rbs/cli.rb:1016
  def run_test(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:457
  def run_validate(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:852
  def run_vendor(args, options); end

  # pkg:gem/rbs#lib/rbs/cli.rb:88
  def stderr; end

  # pkg:gem/rbs#lib/rbs/cli.rb:87
  def stdout; end

  # pkg:gem/rbs#lib/rbs/cli.rb:1006
  def test_opt(options); end
end

# pkg:gem/rbs#lib/rbs/cli.rb:96
RBS::CLI::COMMANDS = T.let(T.unsafe(nil), Array)
...
# pkg:gem/rbs#lib/rbs/cli/diff.rb:5
class RBS::CLI::Diff
  # pkg:gem/rbs#lib/rbs/cli/diff.rb:6
  def initialize(stdout: T.unsafe(nil), stderr: T.unsafe(nil)); end

  # pkg:gem/rbs#lib/rbs/cli/diff.rb:11
  def run(argv:, library_options:); end

  # pkg:gem/rbs#lib/rbs/cli/diff.rb:62
  def run_diff(diff); end

  # pkg:gem/rbs#lib/rbs/cli/diff.rb:73
  def run_markdown(diff); end
end

# pkg:gem/rbs#lib/rbs/cli.rb:14
class RBS::CLI::LibraryOptions
  # pkg:gem/rbs#lib/rbs/cli.rb:21
  def initialize; end

  # pkg:gem/rbs#lib/rbs/cli.rb:16
  def config_path; end

  # pkg:gem/rbs#lib/rbs/cli.rb:16
  def config_path=(_arg0); end

  # pkg:gem/rbs#lib/rbs/cli.rb:15
  def core_root; end

  # pkg:gem/rbs#lib/rbs/cli.rb:15
  def core_root=(_arg0); end

  # pkg:gem/rbs#lib/rbs/cli.rb:19
  def dirs; end

  # pkg:gem/rbs#lib/rbs/cli.rb:18
  def libs; end

  # pkg:gem/rbs#lib/rbs/cli.rb:30
  def loader; end

  # pkg:gem/rbs#lib/rbs/cli.rb:17
  def repos; end

  # pkg:gem/rbs#lib/rbs/cli.rb:58
  def setup_library_options(opts); end
end

# pkg:gem/rbs#lib/rbs/cli/validate.rb:5
class RBS::CLI::Validate
  # pkg:gem/rbs#lib/rbs/cli/validate.rb:48
  def initialize(args:, options:); end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:79
  def run; end

  private

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:190
  def validate_class_module_alias_definition; end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:92
  def validate_class_module_definition; end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:239
  def validate_constant; end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:249
  def validate_global; end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:199
  def validate_interface; end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:258
  def validate_type_alias; end
end

# pkg:gem/rbs#lib/rbs/cli/validate.rb:6
class RBS::CLI::Validate::Errors
  # pkg:gem/rbs#lib/rbs/cli/validate.rb:7
  def initialize(limit:); end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:12
  def add(error); end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:25
  def finish; end

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:17
  def try(&block); end

  private

  # pkg:gem/rbs#lib/rbs/cli/validate.rb:38
  def build_message(error); end
end
...
class RBS::RDocPlugin::Parser
  ...
  # pkg:gem/rbs#lib/rdoc_plugin/parser.rb:148
  def construct_comment(context:, comment:); end

  # pkg:gem/rbs#lib/rdoc_plugin/parser.rb:159
